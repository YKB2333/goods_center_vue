  ...
  <div id="goods-order" class="van-hairline--bottom">
    ...
    >
      <van-tab name="updateDate">
        <span title="默认" slot="title">
          默认
          <!-- <img v-if="timeOrder === 0" :src="require('@/assets/images/order.png')" width="13" />
          <img v-if="timeOrder === 1" :src="require('@/assets/images/order-desc.png')" width="13" />
          <img v-if="timeOrder === 2" :src="require('@/assets/images/order-asc.png')" width="13" />-->
        </span>
      </van-tab>
      <van-tab name="amt">
      ...
      <van-tab name="validityStock">
        <span title="库存" slot="title">
          ...
          <img v-if="stockOrder === 1" :src="require('@/assets/images/order-desc.png')" width="13" />
